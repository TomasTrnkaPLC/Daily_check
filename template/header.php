...
<html lang="en" class="light-theme">
  <head>
    ...
    <script src="template/assets/plugins/datatables/datatables.js"></script>
    <script src="template/assets/js/table-datatable.js"></script>
    <script src="template/assets/js/trumbowyg.js"></script>
    <script src="template/assets/js/trumbowyg.pasteimage.js"></script>
