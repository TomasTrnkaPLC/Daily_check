...
if (isset($updateUser)) {
 ...
 ?>
    ...
    <?php
    $getUinfo = $klient->getCareInfoByIdEdit($userid);
    if ($getUinfo) {
    ?>
      <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form class="" action="" method="POST">  
                    ...
                    <div class="col-6">
                     ...
                     <textarea id="link" name="link"  name="Descripcion"  required><?php echo $getUinfo->link; ?></textarea>
                   
                 
                   <div class="form-group pt-3">
                   <select name = 'series' id='series' class="form-control">
                       <option value = "<?php echo $getUinfo->ckeck_list_id; ?>"><?php echo $klient-> Model_toName($getUinfo->ckeck_list_id); ?></option>
                            <?php
